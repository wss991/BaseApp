...
public class TestBeanDao extends AbstractDao<TestBean, Void> {
    ...
    public static class Properties {
        public final static Property RestId = new Property(0, int.class, "restId", false, "REST_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TEST_BEAN\" (" + //
                "\"REST_ID\" INTEGER NOT NULL ," + // 0: restId
                "\"NAME\" TEXT);"); // 1: name
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TestBean entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getRestId());
    ...
    public void readEntity(Cursor cursor, TestBean entity, int offset) {
        entity.setRestId(cursor.getInt(offset + 0));
