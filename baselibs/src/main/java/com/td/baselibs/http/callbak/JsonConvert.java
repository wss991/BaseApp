    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != ApiResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                ApiResponse lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
                int code = lzyResponse.getErrcode();
                //这里的0是以下意思
                ...
                if (code == 0) {
                    ...
                    throw new ApiException(lzyResponse.getErrcode(), lzyResponse.getErrdesc());
                }
            }
        }
    }
